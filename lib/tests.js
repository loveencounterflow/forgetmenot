...
(function() {
  ...
  if (module.parent == null) {
    include = ["create memo object (1)", "create memo object (2)", "create memo object with path", "set and get to and from cache", "warn about missing features"];
    this._prune();
    this._main();
  }
